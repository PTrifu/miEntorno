...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/view.css')); ?>" media="all">
...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<span id="calendar_3">
			<img id="cal_img_3" class="datepicker" src="<?php echo e(asset('images/calendar.gif')); ?>" alt="Pick a date.">	
		</span>
	...
	<img id="bottom" src="<?php echo e(asset('images/bottom.png')); ?>" alt="">
	</body>
</html><?php /**PATH /var/www/html/resources/views/producto.blade.php ENDPATH**/ ?>